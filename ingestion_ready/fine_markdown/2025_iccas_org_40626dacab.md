...
## ICCAS with IJCAS option:

**Author:** iccas_admin
**Date:** 2025-01-21 00:32
**Views:** 4860
...
The purpose of the ICCAS with IJCAS option is to provide a possibility to publish a paper in the Journal, but present it at ICCAS. Authors can submit an extended abstract (1 or 2 pages) to ICCAS, and simultaneously submit a journal version (at least 6 pages) to IJCAS. The submission deadline for such joint contributions is May 31, 2025.
...
Submitted manuscripts to the special issue should neither have been published nor be under review elsewhere. They will undergo peer-review following the IJCAS author guidelines. Accepted papers are tentatively scheduled for publication in the _2025 issue of IJCAS_.
...
1.  At ICCAS ([https://2025.iccas.org](https://2025.iccas.org/)), please check the “Yes” option as:
    I like to submit the extended version of this paper to IJCAS. **_Yes_** No
...
ICCAS 2025 Organizing Committee
