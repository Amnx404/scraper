...
These rules are prepared for the _23rd International F1TENTH Autonomous Racing Competition_. Rules are subject to change.
...
1.  The competition will comprise three parts – _Inspection and Orientation_ , _Time Trials_ and _Two-Vehicle Head-to-Head_ race. Every participant will be automatically registered for both races (subject to qualification as detailed later).
...
4.  In order to better accommodate all participating teams, all teams should have at most 5 team members present at the race space (includes sideline and seating area) during the event. Teams with more than 5 members will be required to either register as separate teams or discard/cycle their members during the event.
...
4.  The car needs to provide beforehand that it is able to avoid static and dynamic obstacles. This is evaluated by the race referees with a test:
    ...
    *   These obstacles consist of size up to 35×32×30 cm, made from LiDAR perceivable material (e.g., cardboard).
    *   The racecars must show their ability to avoid those obstacles.
    *   Based on this result, the access to the race is granted.
