# RoboRacer Autonomous Racing Competition Rules

These rules are prepared for the _18th International RoboRacer Autonomous Racing Competition_. Rules are subject to change. The latest version can be found [here](https://iv2024-race.f1tenth.org/rules.html).
...
The preferred communication method with the organizers is the _#IV2024_ channel on [Roborace-teams Slack](https://join.slack.com/t/f1tenth-teams/shared_invite/enQtMzc3ODU2ODM1NzE3LTBjMmVkMzZjZTJiNWUzZDFhZTJiODgzMjg0MTA1MDAxZTUxMzkwMDRhNTM2NzdjNDc5MTk5YTc5YmNhNTdhMTU).
...
2.  Teams registered to the in-person competition need to provide and build a Roborace vehicle by themselves according to the constraints listed below. In addition, each team must have a unique vehicle (i.e., a research lab may not field six teams with one car).
3.  To increase the quality of the future Roborace competitions, the winner of each race is encouraged to publish the code of their algorithm under an open-source license in the [Roborace repository](https://github.com/f1tenth) on Github.
...
2.  **Restricted Class** allows only cars that meet the following constraints:
    ...
    *   **RoboRacer Autonomous Racing Competition is a battle of algorithms. Any hardware that should turn the odds in your favor is not allowed**.
...
3.  **Open Class** allows cars that do not fit into Restricted Class. These cars may compete, but they are not eligible for prizes, their ranking is kept separate, and you might not have any peers competing in the class. In addition, the following constraints are applied:
    *   Car dimensions should be within 20% difference to the dimensions of the car required in the Restricted Class. This is to make sure that the car can fit comfortably in the racing track and that it can compete with other cars in the Head-to-Head race.
...
*   _Fastest lap time_. The laptime will be measured with specific equipment by the race director.
*   _Number of consecutive uninterrupted laps_
