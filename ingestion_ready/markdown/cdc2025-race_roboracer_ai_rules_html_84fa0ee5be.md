...
Only cars that meet the following constraints will be allowed to participate:
  ...
  9. _Tires_ : There are no resutrictions on the tires used by the car. Any and all tires that fit the wheels of the chassis are permitted. Any and all tire additives are **not** allowed.
  ...
  11. _Transmitter Spot_ : The car must have a designated spot at the front-half of the car of atleast 8cm x 12cm for a transmitter. The spot should be easily accessible and nothing should be on top of the transmitter. This spot will be used for a transmitter that will be used for time-keeping.
...
Additionally, during open practice and head-to-head races, the car is required to be equipped with the following:
  ...
  3. The car has to be easily perceivable by other cars’ LiDARs. Therefore, the car **must occupy a space of size at least 12×12 cm at every horizontal plane between 10 to 30 cm above the ground**. Usually, this is achieved by placing a 12x12x20cm box on top of the car at the back.
...
Each team will be evaluated based on the following criteria:
  ...
  1. _Fastest lap time_. The laptime will be measured with a time-keeping system provided by the race director.
