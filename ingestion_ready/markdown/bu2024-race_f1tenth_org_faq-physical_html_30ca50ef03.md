...
### Mechanics
  ...
  * Is it allowed to use different tires than those coming with the car? Yes, any and all tires that fit the wheels of the chassis are permitted within reason. The organizers reserve the right to dismiss teams with tires that damage the track and/or other cars and any other tires that may be deemed unsuitable. If you are unsure if your tires are permitted, ask us on [Slack](https://f1tenth-teams.slack.com/archives/C027T45B477). <!– Yes, but only the tires from the list below. If you want to use something else, ask us at [Slack](https://f1tenth-teams.slack.com/archives/C027T45B477) and we may extend the list. All teams should have a chance to use the same tires so we will allow only tires easily available to everybody.

Currently allowed tires are:

    * [GRP Tyres T03 REVO](https://www.grpgandini.it/tyres/1-8-gt/t03-revo.html) All compounds (XB1 to XM7), all rim styles/colors are allowed.

    * [GRP Tyres T04 SLICK](https://www.grpgandini.it/tyres/1-8-gt/t04-slick.html) All compounds (XB1 to XM8), all rim styles/colors are allowed.

    * [Dynamite SpeedTreads Watch Dog (DYN8276)](https://nitrohobbies.com/dyn8276-2/)

    * [AKA 1:8 Buggy Tires](https://www.raceaka.com/18-Buggy-Tires_c_7.html) All Sub-Categories, all compounds, all inserts, all rims (types and colors).

    * [Contact RC tyres](https://www.racing-cars.com/wheels-tyres/on-road-tyres/brand-brand=contact-rc/) *Sh-types, all rims (types and colors) –>
