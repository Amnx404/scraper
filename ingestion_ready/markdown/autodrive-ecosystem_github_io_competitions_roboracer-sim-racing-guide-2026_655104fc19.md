...
![](/../assets/images/documentation/roboracer sim racing league/Simulator 2026.png)
...
#### 1.2.2. HUD Panel¶
  ...
  * **Race Telemetry:** Current elapsed lap time (s), last lap time (s), overall best lap time (s), total lap count as well as collision count data.
...
![](/../assets/images/documentation/roboracer sim racing league/Devkit 2026.png)
