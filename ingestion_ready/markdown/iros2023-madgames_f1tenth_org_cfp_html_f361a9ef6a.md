...
4-6 pages, including references. The paper should be in PDF format and use the standard [IEEE ICRA Conference template](http://ras.papercept.net/conferences/support/support.php). Accepted paper will be made available on the website and the authors are invited to make an additionl oral (live) presentations, or a video highlight.  [Submission Site](https://cmt3.research.microsoft.com/MADGames2023/)

### Important Dates

  * Submission site opens: May 1st, 2023
  * Submission deadline: ~~August 15th, 2023~~ September 15th, 2023 (AoE)
  * Notice of Acceptance: ~~September 1st~~ September 21th, 2023 (AoE)
