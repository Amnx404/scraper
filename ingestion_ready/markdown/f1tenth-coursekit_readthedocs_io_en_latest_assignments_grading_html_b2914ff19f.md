...
Grading rubrics for all 8 labs and the final projects can be found [here](https://docs.google.com/spreadsheets/d/1zbbqYJ3zdfNtegcT-3L4uwd-yt-gWFyf/edit?usp=sharing&ouid=116660630717436430566&rtpof=true&sd=true). You will want to download a copy of this rubric to edit.

Note that these rubrics are available to the students at the beginning of each lab so the expectations are transparent.

## Races¶

The grading rubic for all three races can be found [here](https://docs.google.com/spreadsheets/d/1gvkIyaZuPUC6-Cb7FpFiT8ZrpwOfUKHX/edit?usp=sharing&ouid=116660630717436430566&rtpof=true&sd=true).
...
>
>   * ![+](../_images/math/26d77804f7b0232a53e8432702479a275a171831.png) (5/7)*10 points for completing 7 consecutive laps
>
>   * ![+](../_images/math/26d77804f7b0232a53e8432702479a275a171831.png) (16/23.48)*10 points for best lap time
>
...
Race 3 is a single elimination tournament.
  ...
  3. In the **Race3Brackets** tab, click _Bracket Maker_ which can be founder after _Help_ in the tool bar.

  4. After the first round, you will have to fill in the other rounds manually.

More information on the script can be found [here](https://developers.google.com/apps-script/articles/bracket_maker).
