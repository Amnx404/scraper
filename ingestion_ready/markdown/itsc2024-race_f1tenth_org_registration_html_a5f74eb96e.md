...
The following Google form is only for preliminary registration and for orientation and information sessions. Registration to ITSC 2024 is expected for all competitors.
...
If you have registered for participation but the list below is not updated, please contact us at . Register the modified information under the same team name, and we will update it accordingly.
