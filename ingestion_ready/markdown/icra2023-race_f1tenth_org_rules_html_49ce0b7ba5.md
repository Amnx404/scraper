...
#### 2.1 Vehicle classes
  ...
  2. **Restricted Class** allows only cars that meet the following constraints:
     ...
     5. _Main Computation Unit_ : **Nvidia Jetson Xavier NX** , Equivalents to the Nvidia Jetson NX (e.g. Nvidia Jetson TX2, Nvidia Jetson Nano), or anything of equal or lower GPU and CPU specification is allowed. Examples of possible computation units could be: Raspberry Pi, Arduino, Beaglebone.
